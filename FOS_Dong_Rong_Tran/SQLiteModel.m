...
{
    NSString* createQuery = @"CREATE TABLE IF NOT EXISTS tbl_Cart (id INTEGER PRIMARY KEY AUTOINCREMENT, food_id INTEGER NOT NULL, food_category VARCHAR(255) NOT NULL, food_name VARCHAR(255) NOT NULL, food_add VARCHAR(255) NOT NULL, numberOfNeed INTEGER NOT NULL, food_price DOUBLE NOT NULL, food_date VARCHAR(255) NOT NULL);";
